...
class LaravelGettextServiceProvider extends ServiceProvider
{
    ...
    {
        // Package commands
        $this->app->bind('translations::gettext.create', function ($app) {
            return new Commands\GettextCreate();
        });

        $this->app->bind('translations::gettext.update', function ($app) {
            return new Commands\GettextUpdate();
        });

        $this->commands([
            'translations::gettext.create',
            'translations::gettext.update',
        ]);
    }
